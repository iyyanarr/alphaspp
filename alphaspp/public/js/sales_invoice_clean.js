                    ...
                    callback: function(r) {
                        if (r.message) {
                            ...
                            itemsToUpdate.forEach(item => {
                                ...
                                if (refCode) {
                                    frappe.model.set_value('Sales Invoice Item', item.name, 'custom_customer_ref_code', refCode);
                                }
                            });
    ...
    customer: function(frm) {
        ...
        if (frm.doc.items) {
            frm.doc.items.forEach(function(item) {
                frappe.model.set_value('Sales Invoice Item', item.name, 'custom_customer_ref_code', '');
            });
        }
